...
function M.setup()
  ...
  hl(0, "NvimTreeFolderName",         { fg = c.keyword })
  hl(0, "NvimTreeOpenedFolderName",   { fg = c.keyword, bold = true })
  hl(0, "NvimTreeEmptyFolderName",    { fg = c.keyword })
  hl(0, "NvimTreeFolderIcon",         { fg = c.keyword })
  hl(0, "NvimTreeOpenedFolderIcon",   { fg = c.keyword })
  hl(0, "NvimTreeClosedFolderIcon",   { fg = c.keyword })
  hl(0, "NvimTreeSymlink",            { fg = c.cyan_link })
  ...
  -- Neo-tree
  hl(0, "NeoTreeNormal",              { fg = c.fg_muted, bg = c.bg_darker })
  hl(0, "NeoTreeNormalNC",            { fg = c.fg_muted, bg = c.bg_darker })
  hl(0, "NeoTreeDirectoryName",       { fg = c.keyword })
  hl(0, "NeoTreeDirectoryIcon",       { fg = c.keyword })
  ...
  hl(0, "NeoTreeExpander",            { fg = c.comment })

  -- mini.files
  hl(0, "MiniFilesDirectory",         { fg = c.keyword })
